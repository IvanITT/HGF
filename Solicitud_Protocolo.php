...
if($Dato5=="Ingeniería en Gestión Empresarial"){$Dato3="Ingeniería en Gestión Empresarial";
                                               
}else if($Dato5=="Ingeniería en Tecnologías de la Información y Comunicaciones"){$Dato3="Ingeniería en Tecnologías de la Información y Comunicaciones";}

else if($Dato5=="Ingeniería Electrónica"){$Dato3="Ingeniería Electrónica";}

  
//Cargar la plantilla
$template = 'templates/Titulacion/TecNM-AC-PO-006-01.docx';
...
$output_file_name = str_replace('.', ' '.$Dato4.$save_as.'.', $template);
...
if (!$save_as==='') {
    ...
    $ndoctemp = "templates/Titulacion/Temporal/".$Dato4." - Solicitud del acto protocolario.docx";
    ...
    header('Location: front_Solicitud_Protocolo.php');
