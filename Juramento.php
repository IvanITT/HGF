...
//Cargar la plantilla
$template = 'templates/Titulacion/JURAMENTO.docx';
...
if (!$save_as==='') {
    ...
    $ndoctemp = "templates/Titulacion/Temporal/Juramento de Ética Profesional ".$Dato2.".docx";
    ...
    header('Location: font_Juramento.php');
