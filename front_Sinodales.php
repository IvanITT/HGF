...
<h3 align="center">Oficio de Solicitud de Asignación de Sinodales</h3>
<br>
            ...
            <div class="form-holder ">
                <div class="form-content col-md-10">
                    <div class="form-items">
                     ...
                     <form name="form1" method="post" action="./Sinodales.php">
                         ...
                         <div class="col-md-12 mt-4">
							<div class="row">
    							...
    							<div class="col-md-8">
									<input class="form-control" type="number" name="oficio" placeholder="Revisar el orden de los oficios emitidos por la DEP" maxlength="60" value="000" required>
    							</div>
  							</div>	
                            </div>
                          ...
                          <div class="col-md-12 mt-4">
							<div class="row">
    							<div class="col-md-4 mt-1">
									<p2><strong>Dirigido a:</strong></p2>  
    							</div>
								
    							<div class="col-md-8">
									<select id="departamento" name="departamento" class="form-select" style="width: 100%;height: 140%" required>
                                      <option selected disabled value="">Seleccionar</option>
                                      <option value="1">Dpto. Ingenierías (IE / ITIC)</option>
                                      <option value="2">Dpto. Económico - Administrativas (IGE)</option>  
                               		</select>
    							</div>
  							</div>
							<br>	
							...
							<div class="row">
    							...
    							<div class="col-md-8">
                                    <textarea class="form-control" type="text" name="proyecto" rows="3" minlength="1" maxlength="250" placeholder="Título del proyecto" required></textarea>
    							</div>
  							</div>	
                            </div>
                         ...
                         <div class="col-md-12 mt-4">
							<div class="row">
    							...
    							<div class="col-md-8">
									<select id="lugar" name="opcion" class="form-select" style="width: 100%;height: 140%" required>
                                      <option selected disabled value="">Seleccionar</option>
							...
							<br>	
								...
								<a type="button" class="btn btn-danger" href="front_Sinodales.php" style="margin-left: 20px;color: #FFFFFF; text-decoration: none;">Limpiar</a>
                            </div>
