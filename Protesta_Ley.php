...
if($sexo == "Hombre"){
    $Dato3= "Ciudadano Ingeniero";     
}else if ($sexo == "Mujer"){
    $Dato3= "Ciudadana Ingeniera";
}
...
//Cargar la plantilla
$template = 'templates/Titulacion/PROTESTA_DE_LEY.docx';
...
if (!$save_as==='') {
    ...
    $ndoctemp = "templates/Titulacion/Temporal/Protesta de ley ".$Dato2.".docx";
    ...
    header('Location: font_Protesta_Ley.php');
