...
<h3 align="center">Guión para Acto Protocolario</h3>
<br>
            ...
            <div class="form-holder ">
                <div class="form-content col-md-10">
                    <div class="form-items">
                     ...
                     <form name="form1" method="post" action="./Guion.php">
                         ...
                         <div class="col-md-12 mt-4">
							<div class="row">
    							...
    							<div class="col-md-8">
									<input class="form-control" type="text" name="grado_vocalsuplente" placeholder="Ing. / Lic. / M.C. / M.F / Dr. / Dra. / etc." maxlength="20" required>
    							</div>
  							</div>	
                            </div>
                          ...
                          <div class="col-md-12 mt-4">
                           ...
                           <div class="col-md-12 mt-4">
							...
							<br>	
								...
								<a type="button" class="btn btn-danger" href="front_Guion.php" style="margin-left: 20px;color: #FFFFFF; text-decoration: none;">Limpiar</a>
                            </div>
