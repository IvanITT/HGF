...
<h3 align="center">Protesta de Ley</h3>
<br>
            ...
            <div class="form-holder ">
                <div class="form-content col-md-10">
                    <div class="form-items">
                     ...
                     <form name="form1" method="post" action="./Protesta_Ley.php">
                         ...
                         <div class="col-md-12 mt-4">
							...
							<div class="row">
    							...
    							<div class="col-md-8">
									<input class="form-control" type="text" name="nombre" style="text-transform:uppercase;" placeholder="Nombre del egresado(a)" maxlength="60" required>
    							</div>
  							</div>	
                            </div>
							...
							<br>	
								...
								<a type="button" class="btn btn-danger" href="front_Protesta_Ley.php" style="margin-left: 20px;color: #FFFFFF; text-decoration: none;">Limpiar</a>
                            </div>
