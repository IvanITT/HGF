...
<h3 align="center">Código de Ética Profesional</h3>
<br>
            ...
            <div class="form-holder ">
                <div class="form-content col-md-10">
                    <div class="form-items">
                     ...
                     <form name="form1" method="post" action="./Codigo_Etica.php">
                         ...
                         <div class="col-md-12 mt-4">
							...
							<br>	
								...
								<a type="button" class="btn btn-danger" href="front_Codigo_Etica.php" style="margin-left: 20px;color: #FFFFFF; text-decoration: none;">Limpiar</a>
                            </div>
