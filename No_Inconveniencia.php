...
//Cargar la plantilla
$template = 'templates/Titulacion/TecNM-AC-PO-006-02.docx';
...
$output_file_name = str_replace('.', ' '.$Dato.$save_as.'.', $template);
...
if (!$save_as==='') {
    ...
    $ndoctemp = "templates/Titulacion/Temporal/".$Dato." - Constancia de No Inconveniencia.docx";
    ...
    header('Location: front_No_Inconveniencia.php');
