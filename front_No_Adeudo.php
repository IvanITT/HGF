...
<h3 align="center">Constancia de no adeudo</h3>
<br>
            ...
            <div class="form-holder ">
                <div class="form-content col-md-10">
                    <div class="form-items">
                     ...
                     <form name="form1" method="post" action="./No_Adeudo.php">
                         ...
                         <div class="col-md-12 mt-4">
                          ...
                          <div class="col-md-12 mt-4">
							<div class="row">
    							...
    							<div class="col-md-8">
									<select id="estatus" name="carrera" class="form-select" style="width: 100%;height: 140%" required>
                                      ...
                                      <option value="Tecnologías de la Información y Comunicaciones">Ingeniería en Tecnologías de la Información y Comunicaciones</option>
							...
							<br>	
								...
								<a type="button" class="btn btn-danger" href="front_No_Adeudo.php" style="margin-left: 20px;color: #FFFFFF; text-decoration: none;">Limpiar</a>
                            </div>
